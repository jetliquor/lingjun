    ...
    <div class="container">
        ...
        <div class="job_list">
            ...
            <div class="title bigger bold">
                ...
                运营经理（干洗）
                <div class="gotop">
                    <a href="#anchor_jobs" class="position">返回顶部</a>
                </div>
            </div>
            <div class="line"></div>
            <div class="bold">职位描述：</div>
            <div class="para">
                <div class="para">
                    <ol>
                        <li>&nbsp;负责团队管理、人员招聘和维系工作；</li>
                        <li>&nbsp;制定操作标准，形成从销售至服务、物流等的一系列运营管理；</li>
                        <li>&nbsp;带领市场团队拓展客户群，提升订单量。</li>
                    </ol>
                </div>
            </div>
            <div class="bold">职位要求：</div>
            <div class="para">
                <div class="para">
                    <ol>
                        <li>本科或以上学历，市场营销相关专业；</li>
                        <li>5年以上市场运营管理经验；</li>
                        <li>具备优秀的团队管理和市场推广能力；</li>
                        <li>熟悉O2O的运营模式，可在不同环境中，及时改进运营策略。</li>
                    </ol>
                </div>
            </div>
        </div>
